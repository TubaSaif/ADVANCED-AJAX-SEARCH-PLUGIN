...
if ( ! function_exists( 'aasp_get_option' ) ) :
	...
	function aasp_get_option( $key ) {
		...
		return apply_filters( 'aasp_get_option', wp_parse_args ( $value ) );
	}
...
if ( ! function_exists( 'aasp_default_theme_options' ) ) :
	/**
	 * Get theme option.
	 *
	 * @since 1.0.0
	 ...
	 * @return mixed Option value.
	 */
	function aasp_default_theme_options( ) {
		...
		$defaults['aasp_search_results']  =  array(
		...
		// Pass through filter.
		$defaults = apply_filters( 'aasp_default_theme_options', wp_parse_args ( $defaults ) );
